//Pause Screen for Level-1(GamePlayScreen-1).
...
public class PauseScreen implements Screen {
    ...
    private Game1State game1State;

    public PauseScreen(AngryBirdsGame game, Game1State game1Statein) {
        // game1State will indicate from which state this game has been called
        this.game = game;
        this.batch = new SpriteBatch();
        background = new Texture("AngryBirdsBackground.jpg");
        game1State = game1Statein;
    }
    ...
    public void render(float delta) {
        ...
        if (switchscreen1) { // return to game
            game.setScreen(new GamePlayScreen(game, game1State)); // reload function
            ...
            // Json json = new Json();
            // try (FileWriter writer = new FileWriter("C:\\Users\\Arpit Raj\\Desktop\\AngryBirds-Game\\core\\src\\main\\java\\com\\angrybird\\screens\\savedgames.json")) {
            //     json.toJson(game1State, writer);
            //     System.out.println("Game states saved to " + "C:\\Users\\Arpit Raj\\Desktop\\AngryBirds-Game\\core\\src\\main\\java\\com\\angrybird\\screens\\savedgames.json");
            // } catch (Exception e) {
            //     e.printStackTrace();
            // }
