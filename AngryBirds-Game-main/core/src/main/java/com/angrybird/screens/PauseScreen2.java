//Pause Screen for Level-2(GamePlayScreen-2).
...
public class PauseScreen2 implements Screen {
    ...
    Game2State gameStatein;

    public PauseScreen2(AngryBirdsGame game, Game2State gameState) {
        this.game = game;
    ...
    public void render(float delta) {
        ...
        if (switchscreen1) {
            game.setScreen(new GamePlayScreen2(game, gameStatein));
            ...
            // Json json = new Json();
            // try (FileWriter writer = new FileWriter("C:\\Users\\Arpit Raj\\Desktop\\AngryBirds-Game\\core\\src\\main\\java\\com\\angrybird\\screens\\SavedGamesLvl2.json")) {
            //     json.toJson(gameStatein, writer);
            //     System.out.println("Game states saved to " + "C:\\Users\\Arpit Raj\\Desktop\\AngryBirds-Game\\core\\src\\main\\java\\com\\angrybird\\screens\\SavedGamesLvl2.json");
            // } catch (Exception e) {
            //     e.printStackTrace();
            // }
