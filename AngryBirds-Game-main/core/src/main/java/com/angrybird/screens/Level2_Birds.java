...
public class Level2_Birds implements Screen {
    ...
    public Level2_Birds(AngryBirdsGame game) {
        this.game = game;
    ...
    public void show() {
        ...
        bird2Inactive = new Texture("Bebo1.jpg");
        bird2Active = new Texture("Bebo2.jpg");
        bird3Inactive = new Texture("Gulabo1.png");
        bird3Active = new Texture("Gulabo2.png");
    ...
    public void render(float delta) {
        ...
        if (isButtonHovered(buttonWidth, buttonHeight, proceedButtonX, proceedButtonY)) {
            ...
            if (Gdx.input.isTouched()) {
                GamePlayScreen2 g2 = new GamePlayScreen2(game);
                game.setScreen(g2);
            }
        } else {
