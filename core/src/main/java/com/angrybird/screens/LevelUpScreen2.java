...
public class LevelUpScreen2 implements Screen {
    ...
    public LevelUpScreen2(AngryBirdsGame game) {
        this.game = game;
        this.batch = new SpriteBatch();
        this.background = new Texture("levelup1.png");
    }
    ...
    public void render(float delta) {
        ...
        if (switchToMainMenu) {
            ...
            game.setScreen(new GamePlayScreen2(game));
        }
    }
    ...
    private void drawBackground() {
        ...
        batch.draw(background, (screenWidth - scaledBgWidth) / 2, (screenHeight - scaledBgHeight) / 2,
            scaledBgWidth, scaledBgHeight); // scaling down the background for fit
    }
